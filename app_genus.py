...
st.write("""
         # Mosquito Genus Classification -  Yolov5s
         """
         )
...
if file is None:
    ...
    image_disp.thumbnail(max_size)
    st.image(image_disp, use_column_width= False)
    genus_dict={0.0: 'Anopheles',1.0: 'Culex',2.0: 'Mansonia',3.0: 'Aedes',4.0: 'Non-mosquito'}
    st.write('### Genus:',genus_dict[genus])
    st.write(f"#### The confidence score is approximately : {conf*100:.2f} % ")
    ### CLASSIFY
