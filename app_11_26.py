...
def load_model():
  ...
  """
  model= torch.jit.load('model/species_with_normalization_26_07_24.ptl', map_location = 'cpu')
  st.write('species_with_normalization_26_07_24.ptl')
...
def load_abd_model():
  ...
  Returns:
      model (torch.nn.Module): The loaded PyTorch model.
  """
  model= torch.jit.load('model/abdomen_with_normalization_29_04_24.ptl', map_location = 'cpu')
  st.write('abdomen_with_normalization_29_04_24.ptl')
  model = model.to(device)
  return model
...
def load_sex_model():
  ...
  Returns:
      model (torch.nn.Module): The loaded PyTorch model.
  """
  model= torch.jit.load('model/sex_with_normalization_27_02_24.ptl', map_location = 'cpu')
  st.write('sex_with_normalization_27_02_24.ptl')
  model = model.to(device)
  return model
