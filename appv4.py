...
OCRTrans=transforms.Compose([ transforms.Grayscale(),transforms.Resize( size=(32, 100)),transforms.ToTensor()])                                  
...
if file is None:
    ...
    OCR_str=get_OCR_string(yolo_cropped_label)
    st.write(OCR_str)
